                ...
                <div :class="['card-body pt-0', { 'text-center': isLoading }]">
                    <form v-if="!isLoading">
                        ...
                        <div class="form-group" v-if="form_data.id">
                            <label v-if="form_data.content_type == 'message'"
                                ><input
                                    type="radio"
                                    name="content_type"
                                    value="message"
                                    class="mx-1"
                                    :checked="
                                        form_data.content_type == 'message'
                                    "
                                    v-model="form_data.content_type"
                                />Message</label
                            >
                            <label
                                class="mx-2"
                                v-if="form_data.content_type == 'image'"
                                ><input
                                    type="radio"
                                    name="content_type"
                                    value="image"
                                    class="mx-1"
                                    :checked="form_data.content_type == 'image'"
                                    v-model="form_data.content_type"
                                />Image</label
                            >
                        </div>
                        ...
                        <div
                            class="form-group"
                            v-if="form_data.content_type == 'message'"
                        >
                            <label>Message</label>
                            <textarea
                                :class="[
...
export default {
    ...
    methods: {
        ...
        deleteImage(filename) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post("/admin/rewarded-ads-image-delete", {
        ...
        submit(e) {
            ...
            if (this.form_data.content_type == "image") {
                if (this.form_data.id) {
            ...
            axios
                .post("/admin/rewarded-ads-manage", fd, {
                    headers: {
                ...
                .then((res) => {
                    this.disabled = false;
                    if (res.data.errors) {
                        console.log(res.data.msg + ".files.0");
                        ...
                        if (!this.form_data.id) {
                            ...
                            this.$router.push({ name: "rewarded-ads-list" });
                        } else {
                            this.form_data.files =
                                res.data.files ?? this.form_data.files;
                            Swal.fire({
                                icon: "success",
                                title: res.data.msg,
                                showConfirmButton: false,
        ...
        if (this.form_data.id) {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.form_data.content_type = res.data.record.type;
