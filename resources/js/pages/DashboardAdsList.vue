                ...
                <div class="card-body">
                    ...
                    >
                        <span class="alert-inner--text">
                            <b>Standard Advertisements</b>: These ads will be
                            showcased on your client app's dashboard, enhancing
...
import DashboardAdsRecords from "../components/DashboardAdsRecords.vue";

export default {
    name: "DashboardAdsList",
    components: {
        BreadCrumb,
        SuccessMessage,
        DashboardAdsRecords,
    ...
    methods: {
        delete(id) {
            axios
                .post("/admin/dashboard-ads-delete", {
                    id: id,
                })
                .then((res) => {
                    if (!res.data.errors) {
    ...
    mounted() {
        ...
        axios.post("/admin/dashboard-ads-list").then((res) => {
